...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/upper_easy_rgb.png}}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/upper_challenging_rgb.png}}
    \end{subfigure}

    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/lower_easy_rgb.png}}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/lower_challenging_rgb.png}}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/upper_easy_nir.png}}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/upper_challenging_nir.png}}
    \end{subfigure}

    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/lower_easy_nir.png}}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreview{./pic/gifs_preview/lower_challenging_nir.png}}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreviewLarge{./pic/gifs_preview/total_easy.png}}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.45\textwidth}
        \href{https://www.youtube.com}{\videoPreviewLarge{./pic/gifs_preview/total_challenging.png}}
    \end{subfigure}
